...
class ODB_EDA_DATA : public AttributeProvider
{
public:
    ODB_EDA_DATA();
    ...
    struct FEATURE_ID 
    {
        ...
        FEATURE_ID( ODB_FID_TYPE aType, uint32_t aLyrNum, uint32_t aFNum )
         : m_type( aType ), m_lyrNum( aLyrNum ), m_featureNum( aFNum )
        {
        }

        ODB_FID_TYPE m_type;
        uint32_t m_lyrNum;
        uint32_t m_featureNum;
