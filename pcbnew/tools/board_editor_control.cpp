...
int BOARD_EDITOR_CONTROL::GenerateFabFiles( const TOOL_EVENT& aEvent )
{
    ...
    else if( aEvent.IsAction( &PCB_ACTIONS::generateODBFile ) )
        m_frame->GenODBPPFiles( dummy );
    // else if( aEvent.IsAction( &PCB_ACTIONS::generateODBFile ) )
    //     m_frame->GenODBFile( dummy );
    else
...
void BOARD_EDITOR_CONTROL::setTransitions()
{
    ...
    Go( &BOARD_EDITOR_CONTROL::GenerateFabFiles,       PCB_ACTIONS::generateODBFile.MakeEvent() );
    Go( &BOARD_EDITOR_CONTROL::GenerateFabFiles,       PCB_ACTIONS::generateODBFile.MakeEvent() );
